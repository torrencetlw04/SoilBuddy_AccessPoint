...
If you want to use MDNS support you have to use a custom build which can be downloaded [here](https://github.com/cbrand/micropython-mdns/releases) or custom build according to [this Dockerfile](https://github.com/cbrand/micropython-mdns/blob/main/Dockerfile.micropython.1.23.rp2).
